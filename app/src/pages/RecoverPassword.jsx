...
function RecoverPassword() {
    ...
    async function resetPassword(newPassword) {
        ...
        try {
            const res = await api.post('/user/reset_password', {
                userName,
                token,
    ...
    return (
        <Page>
            <Container>
                ...
                <TextInput type="text" placeholder="Nova senha" id="password" />
                <TextInput type="text" placeholder="Confirmar nova senha" id="confirmPassword" />
